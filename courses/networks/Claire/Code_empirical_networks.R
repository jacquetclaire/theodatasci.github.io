...
# H2: Remove the correlation between pairs of interactions c_ij and c_ji
Stab_H2 = numeric(length=ndat) # Store the stability of randomized matrices
rep =  numeric(length=100) # replications of the permutation


#########################################################################
# H3: Replace the distribution of the non-zero elements of the community matrix by a bivariate normal distribution   
